...
public class cloudsimTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Save cloudlet list into a file
			writeCloudletResultsToCSV(newList, "test.csv");

			CloudSim.stopSimulation();

			printCloudletList(newList);

			Log.println("Cloudsim Test finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	private static void writeCloudletResultsToCSV(List<Cloudlet> list, String filename) {
        try (FileWriter writer = new FileWriter(filename)) {
            // Header row
            writer.append("CloudletId,Status,DatacenterId,VMId,StartTime,FinishTime,ActualCPUTime\n");
